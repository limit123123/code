...
public class ManagePeriodtFrm extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManagePeriodtFrm frame = new ManagePeriodtFrm();
	 ...
	 * Create the frame.
	 */
	public ManagePeriodtFrm() {
		setClosable(true);
		setIconifiable(true);
		setTitle("Period manage");
		setBounds(100, 100, 842, 561);
		
		JScrollPane scrollPane = new JScrollPane();
		
		JLabel degfullname = new JLabel("regno");
